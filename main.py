...
graph1 = PlaceGraph(root,canvas,fig, bus, 0.8,0.24,0x1000400,2,xtitle='Uren',ytitle='Waardenq') 
ani2 = animation.FuncAnimation(fig,graph1.graph,interval=1000)

graph2 = PlaceGraph(root,canvas, fig2,bus, 0.13,0.12,0x1000400,4,xtitle='Uren',ytitle='Waarden') 
ani3 = animation.FuncAnimation(fig2,graph2.graph,interval=1000)

graph3 = PlaceGraph(root,canvas, fig3,bus, 0.83,0.8,0x1000400,0,xtitle='Uren',ytitle='Waarden') 
ani4 = animation.FuncAnimation(fig3,graph3.graph,interval=1000)

graph4 = PlaceGraph(root,canvas, fig4,bus, 0.24,0.79,0x1000400,1,xtitle='Uren',ytitle='Waarden') 
ani5 = animation.FuncAnimation(fig4,graph4.graph,interval=3000)
